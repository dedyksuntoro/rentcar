...
use Session;
	...
	class AdminCarsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Manufacturer","name"=>"id_manufacturer","join"=>"tbm_car_manufacturer,manufacturer"];
			$this->col[] = ["label"=>"Brand","name"=>"id_brand","join"=>"tbm_car_brand,brand"];
			$this->col[] = ["label"=>"Year","name"=>"year"];
			$this->col[] = ["label"=>"Registration Number","name"=>"registration_number"];
			$this->col[] = ["label"=>"Owner","name"=>"owner"];
			$this->col[] = ["label"=>"Branch","name"=>"id_branch","join"=>"tbm_branch,branch_name"];
			$this->col[] = ["label"=>"On Duty","name"=>"on_duty","visible"=>false];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Manufacturer','name'=>'id_manufacturer','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbm_car_manufacturer,manufacturer'];
			$this->form[] = ['label'=>'Brand','name'=>'id_brand','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbm_car_brand,brand','parent_select'=>'id_manufacturer'];
			$this->form[] = ['label'=>'Year','name'=>'year','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Chassis Number','name'=>'chassis_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Engine Number','name'=>'engine_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Registration Number','name'=>'registration_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Owner','name'=>'owner','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Address','name'=>'address','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Branch','name'=>'id_branch','type'=>'select','validation'=>'required','width'=>'col-sm-10','datatable'=>'tbm_branch,branch_name','datatable_format'=>'branch_name, \' - \', city'];
			//$this->form[] = ['label'=>'Price','name'=>'price','type'=>'money','validation'=>'required|integer','width'=>'col-sm-10'];
			# OLD END FORM
	        ...
	        */
			...
			$this->table_row_color[] = ['condition'=>"[on_duty] == '1'","color"=>"danger"];
