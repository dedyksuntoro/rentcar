<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Place of Birth','name'=>'birth_place','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'1|Laki-laki;2|Perempuan'];
	    ...
	    */
	    public function hook_row_index($column_index,&$column_value) {
	    	//Your code here
            if($column_index == 1 && $column_value == 1){
                $column_value = 'Laki-laki';
            }elseif($column_index == 1 && $column_value == 2){
                $column_value = 'Perempuan';
            }
            if($column_index == 4 && $column_value == 1){
                $column_value = 'Active';
            }elseif($column_index == 4 && $column_value == 2){
                $column_value = 'Banned';
            }
	    }
