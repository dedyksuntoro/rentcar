<?php namespace App\Http\Controllers;
	...
	class AdminSettingusersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Branch','name'=>'id_branch','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tbm_branch,branch_name','datatable_format'=>'branch_name, \' - \', city'];
			...
			$this->form[] = ['label'=>'Privileges','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_privileges,name','datatable_where'=>'id != 1 AND id != 2'];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
            $query->where('cms_users.name','!=','Super Admin');
            $query->where('cms_users.name','!=','Owner');
	    }
